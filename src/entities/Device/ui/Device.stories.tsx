...
CurrentDevice.args = {
  device: {
    ip: '127.0.0.1',
    lastVisit: '2023-05-01T17:04:58.000Z',
...
OtherDevice.args = {
  device: {
    ip: '127.0.0.1',
    lastVisit: '2023-05-01T17:02:03.000Z',
    userAgent: 'Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36',
  },
